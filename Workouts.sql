...
INSERT INTO `Users` VALUES ('bb1','bruce','banner',1290876534,'user'),('hjs','Homer','Simpson',2147483647,'user'),('og39','Omar','Gomez',1234567890,'trainer');
...
CREATE TABLE `assigndRT` (
  ...
  KEY `rID` (`rID`),
  CONSTRAINT `assigndRT_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `Users` (`userID`),
  CONSTRAINT `assigndRT_ibfk_2` FOREIGN KEY (`rID`) REFERENCES `routineDesc` (`rID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `assigndRT` VALUES ('og39','r1'),('bb1','r2'),('hjs','r2'),('og39','r2');
...
CREATE TABLE `passwds` (
  ...
  PRIMARY KEY (`userID`),
  CONSTRAINT `passwds_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `Users` (`userID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `routine2` (
  ...
  PRIMARY KEY (`CurDate`,`Exercise`,`SetNum`,`userID`),
  KEY `userID` (`userID`),
  CONSTRAINT `routine2_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `Users` (`userID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `routine2`
--

LOCK TABLES `routine2` WRITE;
/*!40000 ALTER TABLE `routine2` DISABLE KEYS */;
/*!40000 ALTER TABLE `routine2` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `routineDesc`
--

DROP TABLE IF EXISTS `routineDesc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `routineDesc` (
  `rID` varchar(10) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `routineDesc`
--

LOCK TABLES `routineDesc` WRITE;
/*!40000 ALTER TABLE `routineDesc` DISABLE KEYS */;
INSERT INTO `routineDesc` VALUES ('r1','routine1','db bench, barbell rows, legs curls, skull crushers'),('r2','routine2','do stuff');
/*!40000 ALTER TABLE `routineDesc` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-05-07 16:56:18
